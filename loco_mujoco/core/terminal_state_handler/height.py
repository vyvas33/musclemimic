...
class HeightBasedTerminalStateHandler(TerminalStateHandler):
    ...
    def __init__(self, env: Any, **handler_config: Dict[str, Any]):
        ...
        # Use custom height range if provided, otherwise use environment default
        if 'root_height_healthy_range' in handler_config:
            self.root_height_range = handler_config['root_height_healthy_range']
        else:
