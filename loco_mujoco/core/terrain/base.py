...
class Terrain(StatefulObject):
    ...
    def sample_heights_at_points(self,
        ...
        This method must be implemented by subclasses to provide terrain height
        information for the HeightMatrix observation.

        Args:
            x: Array of x coordinates in world frame.
            y: Array of y coordinates in world frame.
            model (Union[MjModel, Model]): The simulation model.
            carry: Carry instance with terrain state information.
            backend (ModuleType): Backend module (numpy or jax.numpy).

        Returns:
            Union[np.ndarray, jnp.ndarray]: Array of terrain heights at the sample points.

        Raises:
            NotImplementedError: Must be implemented by subclasses.
        """
        raise NotImplementedError("Subclasses must implement sample_heights_at_points")
